...
class BaseRegion(Place, SlugModel):
...
class BaseSubregion(Place, SlugModel):
    slug_contains_id = True

    name_std = models.CharField(max_length=200, db_index=True, verbose_name="standard name")
    code = models.CharField(max_length=200, db_index=True)
    region = models.ForeignKey(
        swapper.get_model_name("cities", "Region"),
...
class BaseCity(Place, SlugModel):
    ...
    subregion = models.ForeignKey(
        swapper.get_model_name("cities", "Subregion"),
        null=True,
        blank=True,
        related_name="cities",
        on_delete=SET_NULL_OR_CASCADE,
...
class BaseDistrict(Place, SlugModel):
    slug_contains_id = True
...
class BaseAlternativeName(SlugModel):
    slug_contains_id = True
...
class BasePostalCode(Place, SlugModel):
    slug_contains_id = True
